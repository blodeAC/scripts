      ...
      for _, keyValue in ipairs(allValueStrings) do
        if lootable then
          ...
          for j = #ruleItem.sorted[keyValue], 1, -1 do
            ...
            local itemValue = item[keyValue] and (item[keyValue][keyForCompare] or item[keyValue][ExtraEnums[keyValue][keyForCompare]] or nil)
...
lootRuleHolder.Visible = (windowData.lootRuleHolder==nil and true) or (windowData.lootRuleHolder.isVisible~=false and true) or false
